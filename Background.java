...
public class Background extends World
{
    ...
    public void addScoreBoard() {
        ...
        scoreboard.addScoreObject("sneakers",pineappleScore);
        
       
        ScoreCount spaceScore = new ScoreCount();
        spaceScore.setImage(spaceScore.getScoreImage(40));
        addObject(spaceScore, 435,30);
        scoreboard.addScoreObject("Space",spaceScore);
